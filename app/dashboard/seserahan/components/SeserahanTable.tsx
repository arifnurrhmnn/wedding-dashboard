...
import { createColumns } from "./SeserahanColumns";
import {
...
export function SeserahanTable({
  data,
  onInlineUpdate,
  onEdit,
  onDelete,
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4 p-4 bg-card border border-border rounded-lg shadow-sm">
        ...
        <Select
          value={
            (table.getColumn("status_pembelian")?.getFilterValue() as string) ??
            "all"
          }
          onValueChange={(value) =>
            table
              .getColumn("status_pembelian")
              ?.setFilterValue(value === "all" ? "" : value)
          }
        >
          <SelectTrigger className="w-full sm:w-[180px] h-10 bg-input border-border">
                ...
                <TableRow>
                  ...
                  >
                    <div className="flex flex-col items-center gap-2 text-muted-foreground">
                      ...
                      <p className="text-sm">Mulai tambahkan seserahan Anda.</p>
                    </div>
                  </TableCell>
                </TableRow>
              )}

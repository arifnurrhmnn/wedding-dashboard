...
import { createColumns } from "./SouvenirColumns";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4 p-4 bg-card border border-border rounded-lg shadow-sm">
        ...
        <Select
          value={
            (table.getColumn("status_pengadaan")?.getFilterValue() as string) ??
            "all"
          }
          onValueChange={(value) =>
            table
              .getColumn("status_pengadaan")
                ...
                <TableRow>
                  ...
                  >
                    <div className="flex flex-col items-center gap-2 text-muted-foreground">
                      ...
                      <p className="text-sm">Mulai tambahkan souvenir Anda.</p>
                    </div>
                  </TableCell>
                </TableRow>
              )}
